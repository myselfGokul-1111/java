...
System.out.println("The order of the matrix is different : Addition not possible");
return(null);
...
System.out.println("The order of the matrix is different : Subtraction not possible");
return(null);
...
class Matrix{
    ...
    public static void main(String[] args)
    {
       ...
       System.out.println("Subtraction result  : " + Arrays.deepToString(result));
